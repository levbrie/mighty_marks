  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.winnow_results = function() {
      ...
      if (results < 1 && searchText.length) {
      	// @levbrie set searchTermToUse to the current unfound String
      	searchTermToUse = searchText;
      	// @levbrie commented out this line in order to enable user to type unfound result 
      	// to be used as search query
